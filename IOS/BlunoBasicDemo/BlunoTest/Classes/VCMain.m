...
{
    NSString *displayText = [NSString stringWithFormat:@"%@ - %d", [[NSString alloc] initWithData:data encoding:NSUTF8StringEncoding], arc4random_uniform(740)];
    self.lbReceivedMsg.text = displayText;
